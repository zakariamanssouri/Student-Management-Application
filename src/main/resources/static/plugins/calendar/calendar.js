...
(function (factory) {
    ...
    Clndr.prototype.init = function () {
        ...
        // Quick and dirty deleteStudent to make sure rendering is possible.
    ...
    Clndr.prototype.createDayObject = function (day, monthEvents) {
        ...
        for (j; j < monthEvents.length; j++) {
            ...
            // deleteStudent. Now all we have to compare is the moment.date(), which
     ...
     * deleteStudent will be removed from the calendar's events. This triggers a render.
     */
